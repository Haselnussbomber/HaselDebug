...
public unsafe partial class DebugRenderer
{
    ...
    public void DrawAtkValues(AtkValue* values, ushort elementCount, NodeOptions nodeOptions)
    {
        ...
        using var table = ImRaii.Table(nodeOptions.GetKey("AtkValuesTable"), 3, ImGuiTableFlags.Borders | ImGuiTableFlags.RowBg | ImGuiTableFlags.ScrollY | ImGuiTableFlags.NoSavedSettings, new System.Numerics.Vector2(-1, 200));
        if (!table) return;
