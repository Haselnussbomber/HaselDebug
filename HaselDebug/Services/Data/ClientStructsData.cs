...
public sealed class ClientStructsData
{
    ...
    [YamlMember(Alias = "globals")] public Dictionary<nint, string> Globals { get; set; } = [];
    [YamlMember(Alias = "functions")] public Dictionary<nint, string> Functions { get; set; } = [];
...
public sealed class XivClass
{
    ...
    [YamlMember(Alias = "funcs")] public Dictionary<nint, string> Functions { get; set; } = [];
...
{
    [YamlMember(Alias = "ea")] public nint Address { get; set; }
