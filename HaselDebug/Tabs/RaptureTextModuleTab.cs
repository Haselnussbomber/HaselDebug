    ...
    private void DrawGlobalParameters()
    {
        ...
        for (var i = 0u; i < deque.MySize; i++)
        {
            ...
            ImGui.TextUnformatted(i switch
            {
                ...
                92 => "TerritoryType Id",
                94 => "LogSetRoleColor 1: LogColorRoleTank (Log Role Color - Tank)",
                95 => "LogSetRoleColor 2: LogColorRoleTank (Log Role Color - Tank)",
                96 => "LogSetRoleColor 1: LogColorRoleHealer (Log Role Color - Healer)",
                97 => "LogSetRoleColor 2: LogColorRoleHealer (Log Role Color - Healer)",
                98 => "LogSetRoleColor 1: LogColorRoleDPS (Log Role Color - DPS)",
                99 => "LogSetRoleColor 2: LogColorRoleDPS (Log Role Color - DPS)",
                100 => "LogSetRoleColor 1: LogColorOtherClass (Log Role Color - Other)",
                101 => "LogSetRoleColor 2: LogColorOtherClass (Log Role Color - Other)",
